...
// private static final Trigger DISABLE_TRIGGER = new
// Trigger(DriverStation::isDisabled);

// static {
// DISABLE_TRIGGER.onTrue((new InstantCommand(() ->
// forEach(PomMotorSubsystem::stopMotor))
// .andThen(() -> forEach(subsystem ->
// subsystem.setIdleMode(false)))).ignoringDisable(true));
// DISABLE_TRIGGER.onFalse(
// new InstantCommand(() -> forEach(subsystem ->
// subsystem.setIdleMode(true))).ignoringDisable(true));
// }
