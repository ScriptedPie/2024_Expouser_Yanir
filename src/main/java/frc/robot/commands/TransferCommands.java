...
// return transfer.startEnd(() -> transfer.setSpeed(TRANSFER_MOTOR_SPEED),
// transfer::stopMotor).until(()->transfer.getTransferSensor());
// }

// public static Command reverseTransfer(Transfer transfer) {
// return transfer.startEnd(() ->
// transfer.setSpeed(REVERSE_TRANSFER_MOTOR_SPEED), transfer::stopMotor);
// }
